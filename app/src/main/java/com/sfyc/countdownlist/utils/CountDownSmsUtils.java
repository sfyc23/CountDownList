 ...
 * 倒计时器类
 */
public class CountDownSmsUtils implements Runnable {
     ...
     *            显示倒计时的文本视图
     * @param countdownText
     *            倒计时中显示的内容，例如："%s秒后重新获取验证码"，在倒计时的过程中会用剩余描述替换%s
     * @param remainingSeconds
     *            倒计时秒数，例如：60，就是从60开始倒计时一直到0结束
     */
    public CountDownSmsUtils(TextView showTextView, String countdownText,
     ...
     *            倒计时秒数，例如：60，就是从60开始倒计时一直到0结束
     */
    public CountDownSmsUtils(TextViewGetListener textViewGetListener,
                             String countdownText, int remainingSeconds) {
